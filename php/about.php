...
<?php include("navbar.php"); ?>
    ...
    <div class="card">
      ...
      <div class="student">
        <div class="slot">
          <img src="public/images/billbo.png">
          <h1>Billy <u>Luong</u></h1>
          <h2>500837275</h2>

        </div>
        <div class="slot">
          <img src="public/images/sheehan.png" >
          <h1>Sheehan <u>Phan</u></h1>
          <h2>500890672</h2>

        </div>
        <div class="slot">
          <img src="public/images/josephCR.png">
          <h1>Phuong Nam <u>Chiu Tran</u></h1>
          <h2>500840717</h2>
        </div>
      </div>
    </div>
